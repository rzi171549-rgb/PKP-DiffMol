...
class ModelCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        if "baselineeq_chemprior_seed0" in net_output:
            for lgw in net_output["baselineeq_chemprior_seed0"]:
                logging_output[lgw] = net_output["baselineeq_chemprior_seed0"][lgw]
